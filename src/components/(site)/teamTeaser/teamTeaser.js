    ...
    <section className={styles.teamTeaser}>
        <div className='sectionWrapper'>
            <div className={'textContainer'} >
                ...
                <h2 className={styles.title} data-aos="fade-right" ><span>Bag </span>Rattet</h2>
                <Link className={styles.button} href="/team" data-aos="fade-right" >Hele Teamet</Link>
            </div> 
            ...
            <div className={styles.driverContainer} >
                    ...
                    <div className={styles.info} data-aos="fade-right">
                            <div>
                                    <h3 className={styles.name} data-aos="fade-right">Mathias Ringgaard</h3>
                                    <p className={styles.role} data-aos="fade-right">Teamleder & Kører</p>
                            ...
                            <div className={styles.stats} data-aos="fade-right">
                            ...
                            <div className={styles.quote} data-aos="fade-right">
                                    <p>
                            ...
                            <div className={styles.buttonContainer} data-aos="fade-right">
